...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todos = __webpack_require__(159);

	var _todos2 = _interopRequireDefault(_todos);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_todos2.default, null), document.querySelector('#root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoContainer = __webpack_require__(160);

	var _todoContainer2 = _interopRequireDefault(_todoContainer);

	var _todoTitle = __webpack_require__(165);

	var _todoTitle2 = _interopRequireDefault(_todoTitle);

	var _todoInput = __webpack_require__(163);
	  ...
	  _createClass(Todos, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_todoTitle2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoContainer = function (_Component) {
	  ...
	  _createClass(TodoContainer, [{
	    ...
	    key: 'addTodo',
	    value: function addTodo(newText) {
	      this.setState({ data: [].concat(_toConsumableArray(this.state.data), [{ text: newText, complete: false }]) });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_todoInput2.default, { addTodo: function addTodo(newText) {
	            return _this2.addTodo(newText);
	          } }),
	        _react2.default.createElement(_todoList2.default, { items: this.state.data, handleToggle: function handleToggle(index) {
	            return _this2.handleToggle(index);
	          } })
	      );
	    }
	  }]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          datas.map(function (data, index) {
	            return _react2.default.createElement(_todoItem2.default, { index: index, key: index, data: data, toggle: function toggle(index) {
	                return _this2.props.handleToggle(index);
	              } });
	          })
	        )
	      );
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", { type: "checkbox", checked: this.props.data.complete, onChange: function onChange() {
	  ...
	  _createClass(TodoInput, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'text', placeholder: 'What needs to be done?', ref: 'newText' }),
	        _react2.default.createElement(
	          'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoTitle = function (_Component) {
	  _inherits(TodoTitle, _Component);

	  function TodoTitle(props) {
	    _classCallCheck(this, TodoTitle);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoTitle).call(this, props));
	  }
